...
const APP_TITLE = 'GHG-Protocol Manager';
...
const navigation = [
  ...
  { name: 'Konzernstruktur', href: '/konzernstruktur', icon: IconFileText },
  { name: 'Berichtsjahr', href: '/berichtsjahr', icon: IconFileText },
  { name: 'Emissionsfaktoren', href: '/emissionsfaktoren', icon: IconFileText },
  { name: 'Scope 1 – Direkte Emissionen', href: '/scope-1-–-direkte-emissionen', icon: IconFileText },
  { name: 'Scope 2 – Indirekte Energieemissionen', href: '/scope-2-–-indirekte-energieemissionen', icon: IconFileText },
  { name: 'Scope 3 – Weitere indirekte Emissionen', href: '/scope-3-–-weitere-indirekte-emissionen', icon: IconFileText },
  { name: 'Emissionen Schnelleingabe', href: '/emissionen-schnelleingabe', icon: IconFileText },
  { name: 'GHG-Berichtsübersicht', href: '/ghg-berichtsuebersicht', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Konzernstruktur', href: '/gateway/apps/69c124661ddc6ec52a6c2836?template=list_page', icon: IconFileText },
  { name: 'Berichtsjahr', href: '/gateway/apps/69c1246d7299804c440448fa?template=list_page', icon: IconFileText },
  { name: 'Emissionsfaktoren', href: '/gateway/apps/69c1246ebeed0889fed560e2?template=list_page', icon: IconFileText },
  { name: 'Scope 1 – Direkte Emissionen', href: '/gateway/apps/69c1246ff4e0dc2324ed9440?template=list_page', icon: IconFileText },
  { name: 'Scope 2 – Indirekte Energieemissionen', href: '/gateway/apps/69c12470c2204e2aa999bcb8?template=list_page', icon: IconFileText },
  { name: 'Scope 3 – Weitere indirekte Emissionen', href: '/gateway/apps/69c12471ef7da5f0b841a1a3?template=list_page', icon: IconFileText },
  { name: 'Emissionen Schnelleingabe', href: '/gateway/apps/69c124726ff6d54a56c2e81c?template=list_page', icon: IconFileText },
  { name: 'GHG-Berichtsübersicht', href: '/gateway/apps/69c124734278d3e6be1ca7c2?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c124661ddc6ec52a6c2836?template=list_page"
