...
export function GhgBerichtsuebersichtDialog({ open, onClose, onSubmit, defaultValues, berichtsjahrList, konzernstrukturList, enablePhotoScan = false, enablePhotoLocation = true }: GhgBerichtsuebersichtDialogProps) {
