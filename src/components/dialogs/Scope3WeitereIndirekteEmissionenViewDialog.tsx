        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            {record.fields.s3_nachweis ? (
              <MediaThumbnail src={record.fields.s3_nachweis} fit="contain" className="w-full rounded-lg border" />
            ) : <p className="text-sm text-muted-foreground">—</p>}
          </div>
          <div className="pt-2 border-t border-border">
            <AttachmentsSection appId={APP_IDS["SCOPE_3_–_WEITERE_INDIREKTE_EMISSIONEN"]} recordId={record.record_id} readOnly />
          </div>
        </div>
      </DialogContent>
    </Dialog>
