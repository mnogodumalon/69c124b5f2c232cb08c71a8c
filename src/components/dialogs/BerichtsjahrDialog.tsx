...
interface BerichtsjahrDialogProps {
  open: boolean;
  onClose: () => void;
...
export function BerichtsjahrDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: BerichtsjahrDialogProps) {
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        return merged as Partial<Berichtsjahr['fields']>;
      });
      setScanSuccess(true);
