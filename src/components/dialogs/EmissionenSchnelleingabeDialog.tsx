...
export function EmissionenSchnelleingabeDialog({ open, onClose, onSubmit, defaultValues, konzernstrukturList, berichtsjahrList, emissionsfaktorenList, enablePhotoScan = false, enablePhotoLocation = true }: EmissionenSchnelleingabeDialogProps) {
