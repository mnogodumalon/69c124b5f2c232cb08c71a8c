...
export function Scope3WeitereIndirekteEmissionenDialog({ open, onClose, onSubmit, defaultValues, konzernstrukturList, berichtsjahrList, emissionsfaktorenList, enablePhotoScan = true, enablePhotoLocation = true }: Scope3WeitereIndirekteEmissionenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'scope_3_–_weitere_indirekte_emissionen');
