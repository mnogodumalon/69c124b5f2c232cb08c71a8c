// Auto-generated. Per-entity form-enhancements config for "GHG-Berichtsübersicht".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["gb_berichtsjahr", "gb_konzerneinheit", "gb_scope1_gesamt", "gb_scope2_marktbasiert", "gb_scope2_standortbasiert", "gb_scope3_gesamt", "gb_gesamt_co2e", "gb_intensitaet_umsatz", "gb_intensitaet_mitarbeiter", "gb_basisjahr_vergleich", "gb_verifizierungsstatus", {"row": ["gb_pruefer_vorname", "gb_pruefer_nachname"]}, "gb_pruefdatum", "gb_kommentare"],
  defaults: {},
  computed: {},
};
