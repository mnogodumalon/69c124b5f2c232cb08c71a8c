// Auto-generated. Per-entity form-enhancements config for "Konzernstruktur".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["einheit_name", "einheit_typ", "uebergeordnete_einheit", "land", "branche", "konsolidierungsmethode", {"row": ["verantwortlich_vorname", "verantwortlich_nachname"]}, "verantwortlich_email", "anmerkungen_einheit"],
  defaults: {},
  computed: {},
};
